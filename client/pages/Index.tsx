...
const vendorCategories = [
  {
    ...
    icon: Building2,
    description:
      "Top-rated restaurants, ballrooms, and rooftops tailored to capacity and style.",
    matches: [
      {
        name: "Luna Terrace",
        tags: ["Rooftop", "City skyline"],
        price: "from $120 / guest",
      },
      {
        name: "Gardenia Hall",
        tags: ["Indoor & outdoor", "On-site catering"],
        price: "from $95 / guest",
      },
    ],
  },
  {
    ...
    icon: Camera,
    description:
      "Capture every emotion with curated photographers and videographers.",
    matches: [
      {
        name: "Frames & Vows Studio",
        tags: ["Documentary", "48h preview"],
        price: "from $1,800",
      },
      {
        name: "Northlight Films",
        tags: ["Cinematic", "Drone coverage"],
        price: "from $2,250",
      },
    ],
  },
  {
    ...
    icon: Music,
    description:
      "DJs and live bands that read the room and sustain energy all night.",
    matches: [
      {
        name: "Pulse Collective",
        tags: ["Hybrid band", "MC included"],
        price: "from $2,100",
      },
      {
        name: "DJ NovaFlow",
        tags: ["Multi-genre", "Interactive"],
        price: "from $1,350",
      },
    ],
  },
  {
    ...
    icon: Palette,
    description:
      "Florists and decorators who craft immersive, share-worthy moments.",
    matches: [
      {
        name: "Bloom & Ember",
        tags: ["Seasonal florals", "Tablescapes"],
        price: "from $980",
      },
      {
        name: "Velvet Atlas",
        tags: ["Lighting design", "Custom installs"],
        price: "from $1,450",
      },
    ],
  },
...
const workflowSteps = [
  {
    ...
    description:
      "Pick celebration type, date, location radius, and a comfort-range budget in under 60 seconds.",
  },
  {
    title: "Match with curated pros",
    description:
      "We cross-check availability, style, and budget signals to surface vendors that fit like magic.",
  },
  {
    title: "Build a persuasive package",
    description:
      "Select or swap vendors, then generate a ready-to-share proposal with transparent pricing.",
  },
  {
    title: "Launch with confidence",
    description:
      "Collaborate with vendors, manage payments, and track to-dos with Eventia’s timeline hub.",
  },
];
...
const smartPackages = [
  {
    ...
    perks:
      "Romantic ballroom, storytelling photography, live quartet dinner set, late-night DJ.",
    total: "$24,600",
  },
  {
    name: "Vibrant Corporate Gala",
    perks:
      "Skyline venue, experiential decor, keynote media team, premium AV concierge.",
    total: "$31,900",
  },
  {
    name: "Milestone Birthday Bash",
    perks:
      "Boutique restaurant buyout, immersive lighting, interactive DJ, photo moments corner.",
    total: "$12,400",
  },
];
...
const vendorGrowthHighlights = [
  {
    ...
    description:
      "Vendors receive qualified requests with context around guest count, vibe, and budget expectations.",
    icon: ShieldCheck,
  },
  {
    title: "Performance dashboard",
    description:
      "Real-time insights reveal conversion rates, reviews, and upsell opportunities across packages.",
    icon: Gauge,
  },
  {
    title: "Co-marketing moments",
    description:
      "Featured placement in Eventia campaigns that target couples, families, and corporate teams.",
    icon: Rocket,
  },
  {
    title: "Partnership concierge",
    description:
      "Dedicated success managers help venues and creators craft irresistible bundles.",
    icon: Handshake,
  },
];
...
export default function Index() {
  ...
  return (
    <div className="relative isolate overflow-hidden">
      ...
      >
        <div className="space-y-8">
          ...
          <h1 className="font-heading text-4xl leading-[1.05] text-foreground sm:text-5xl lg:text-6xl">
            Plan magnetic celebrations with curated venues, storytellers, and
            experience makers in one hub.
          </h1>
          <p className="max-w-xl text-lg text-foreground/75">
            Eventia Celebration Hub orchestrates weddings, baptisms, corporate
            retreats, and milestone parties by matching your date, location, and
            budget to persuasive vendor packages that wow every guest.
          </p>
          <div className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-[0_35px_90px_-60px_rgba(56,91,253,0.35)] backdrop-blur">
            ...
            >
              <label className="flex flex-col gap-2 text-sm font-medium text-foreground/80">
                ...
                <div className="relative">
                  ...
                  <span className="pointer-events-none absolute inset-y-0 right-3 flex items-center text-foreground/40">
                    ▼
                  </span>
                </div>
              </label>
            ...
            <p className="mt-4 text-xs text-foreground/60">
              Instantly see available venues, photographers, entertainment,
              florals, planners, and more matched to your celebration.
            </p>
          </div>
            ...
            <div className="mt-6 space-y-4 text-sm">
              <div className="flex items-start gap-3 rounded-2xl border border-border/60 bg-white/80 px-4 py-3">
                ...
                <div>
                  <p className="font-semibold text-foreground">
                    Casa Victoria, golden-hour terrace
                  </p>
                  <p className="text-foreground/70">
                    Exclusive buyout, five-course menu, guided guest flow.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-border/60 bg-white/80 px-4 py-3">
                ...
                <div>
                  <p className="font-semibold text-foreground">
                    Lens of Light Collective
                  </p>
                  <p className="text-foreground/70">
                    Two lead photographers, super 8 film add-on, 72h highlight
                    delivery.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-border/60 bg-white/80 px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    Hybrid DJ set, custom first-dance mix, after-party upgrade
                    module.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-border/60 bg-white/80 px-4 py-3">
                ...
                <div>
                  <p className="font-semibold text-foreground">
                    Floristry by Bloom & Ember
                  </p>
                  <p className="text-foreground/70">
                    Suspended ceremony installation, curated tablescapes,
                    keepsake bouquet.
                  </p>
                </div>
              </div>
      ...
      <section
        className="border-y border-border/60 bg-white/60 py-12"
        aria-label="Trusted experiences"
      >
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_1fr] lg:items-end">
            ...
            >
              Persuasive recommendations curated for restaurants, photographers,
              DJs, florals, and more.
            </h2>
            <p className="text-base text-foreground/70">
              Browse ready-to-book collaborators with transparent pricing,
              verified reviews, and availability synced to your event date.
            </p>
          </div>
        </div>
          ...
          {vendorCategories.map((category) => (
            ...
            >
              ...
              <div className="pt-2 text-xs text-foreground/50">
                Availability refreshed 3 minutes ago · Add to package with one
                click
              </div>
            </div>
          ))}
      ...
      <section
        id="workflow"
        className="mx-auto w-full max-w-6xl space-y-12 px-6 pb-20"
      >
        <div className="grid gap-10 rounded-3xl border border-border/60 bg-white/80 p-8 shadow-[0_35px_90px_-60px_rgba(255,138,84,0.6)]">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <p className="max-w-xl text-sm text-foreground/70">
              Dynamic checklists, vendor messaging, payment reminders, and
              persuasion tips guide your planning rhythm.
            </p>
          </div>
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 md:flex-row md:items-center md:justify-between">
          <div className="max-w-xl space-y-4">
            ...
            <h2 className="font-heading text-3xl leading-tight text-foreground sm:text-4xl">
              Generate persuasive proposals that make decision-making
              effortless.
            </h2>
            <p className="text-base text-foreground/70">
              Mix professionals from any category, see live-adjusted totals, and
              share branded offers with co-hosts or stakeholders instantly.
            </p>
          </div>
          <div className="grid w-full max-w-lg gap-4 rounded-3xl border border-border/60 bg-white/80 p-8 shadow-[0_30px_80px_-60px_rgba(56,91,253,0.65)]">
            {smartPackages.map((pkg) => (
              <div
                key={pkg.name}
                className="rounded-2xl border border-border/60 bg-white/70 p-5 text-sm"
              >
      ...
      >
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            ...
            <h2
              ...
              className="font-heading text-3xl leading-tight text-foreground sm:text-4xl"
            >
              A marketplace designed for restaurants, photographers, planners,
              and entertainers to thrive.
            </h2>
            <p className="max-w-2xl text-base text-foreground/70">
              Future-ready features include automated availability syncing,
              upsell prompts, and revenue-share marketing campaigns that keep
              your calendar full with the right events.
            </p>
          </div>
          <a
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {vendorGrowthHighlights.map((item) => (
            <div
              key={item.title}
              className="flex gap-4 rounded-3xl border border-border/60 bg-white/80 p-6"
            >
        ...
        <div className="rounded-3xl border border-primary/15 bg-gradient-to-r from-primary/10 via-white to-secondary/10 p-8 text-sm text-foreground/80 md:flex md:items-center md:justify-between">
          <div className="max-w-2xl space-y-2">
            <p className="font-heading text-xl font-semibold text-primary">
              “Eventia filled our off-season with premium bookings.”
            </p>
            <p>
              “Within four weeks we secured three weddings and a corporate
              launch through Eventia. The persuasive proposals and unified
              messaging made it effortless for clients to say yes.”
            </p>
            <p className="text-xs uppercase tracking-[0.35em] text-foreground/40">
              Elena Popescu · Owner, Velvet Atlas Decor
            </p>
          </div>
          <div className="mt-6 flex flex-col gap-2 rounded-2xl border border-white/40 bg-white/70 p-5 text-xs text-foreground/60 md:mt-0">
            <div className="flex items-center gap-2">
              <ShieldCheck className="h-4 w-4 text-primary" /> 42% faster
              booking time
            </div>
            <div className="flex items-center gap-2">
              <Gauge className="h-4 w-4 text-secondary" /> Average inquiry
              response under 2h
            </div>
            <div className="flex items-center gap-2">
              <Rocket className="h-4 w-4 text-primary" /> Featured vendors grow
              revenue 2.6x
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="relative mx-auto flex w-full max-w-5xl flex-col items-center gap-6 px-6 text-center text-white">
          ...
          <p className="max-w-2xl text-base text-white/80">
            Whether you’re hosting an intimate baptism or a 500-guest corporate
            summit, Eventia curates vendors, budgets, and workflows that
            persuade every stakeholder to join the celebration.
          </p>
